#!/bin/sh
# Kids Mode Deluxe boot hook — runs from /mnt/SDCARD/.tmp_update/startup/
...
#
# This file ships in App/KidsModeDeluxe/ and is copied into
...
looper=/mnt/SDCARD/App/KidsModeDeluxe/kid_mode_loop.sh
