#!/bin/sh
# Super Kids Mode boot hook — runs from /mnt/SDCARD/.tmp_update/startup/
...
#
# This file ships in App/SuperKidsMode/ and is copied into
...
looper=/mnt/SDCARD/App/SuperKidsMode/kid_mode_loop.sh
