...
Kids Mode Deluxe brings favorite games and children's videos together in one
...
1. Download `KidsMode-Deluxe.zip`.
2. Copy `KidsModeDeluxe` into the SD card's `App` folder.
3. Add videos to `Media/VideoKidsMode` and covers to
   `Media/VideoKidsMode/Imgs`.
